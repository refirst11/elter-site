---
title: 'Incentive | elter'
subtitle: 'How does elter work?'
date: '2024-09-30'
---
...
# Incentive
On this page good to know when using CSS-in-JS solutions of elter.

## Ease of introduction
The elter mechanism scans and compiles cssx method define using an AST (Abstract Syntax Tree).
...
All you need to do is install the optimization plugin and just compile with `npx elter --compile`.
...
## Static style
elter does not support dynamic variable embedding.
...
In elter, styles are completely statically determined.
...
### Pre compilation
elter's compilation logic is not coupled with the framework's build.
...
The design of using elter objects as hashes for IDs results in collision lottery at the method level,
