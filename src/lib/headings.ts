export const headings = [
  ...
  {
    heading: [
      { id: 'ease-of-introduction', text: '# Ease of introduction' },
      { id: 'concise-api', text: '# Concise API' },
      { id: 'simple-methods', text: '# Simple methods' },
      { id: 'static-style', text: '# Static style' },
      { id: 'avoiding-complexity', text: '# Avoiding complexity' },
      { id: 'complete-static-determinism', text: '# Complete static determinism' },
      { id: 'pre-compilation', text: '# Pre compilation' },
      { id: 'ease-of-debugging', text: '# Ease of debugging' },
